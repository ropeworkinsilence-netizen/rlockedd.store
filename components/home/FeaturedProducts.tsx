  ...
  return (
    <section className="bg-brand-black">
      <div className="border-y border-white/10 py-6 px-4 flex items-center justify-between">
        <h2 className="font-display text-4xl tracking-wider">ÚLTIMOS DROPS</h2>
        <a href="/collections/all" className="font-mono text-xs text-brand-muted tracking-widest">VER TODO</a>
      </div>
